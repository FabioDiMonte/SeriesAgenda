...
var SeriesAgenda = function(){

    function SeriesEpisode(series, season, number, title, date){
    ...
    SeriesAgenda.prototype = {

        addEpisodes: function(){
        ...
        showMyAgenda: function(){
            var dateOrderedAgenda = this.agenda.episodes.sort(function(a,b){
    ...
    function parseEpisodesWiki(excludedIndex){
        ...
        $('table').each(function(i,e){
            ...
            $summary.each(function(i,e){
                ...
                date && episodes.list.push(new SeriesEpisode(title, season, epNumber, epTitle, date));
            });
        });
        return episodes;
    }
